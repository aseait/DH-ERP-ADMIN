                ...
                <UncontrolledDropdown className="card-header-dropdown">
                  <DropdownToggle tag="button" className="btn btn-soft-primary btn-sm">
                    <span className="text-uppercase">
                      Btc<i className="mdi mdi-chevron-down align-middle ms-1"></i>
                    </span>
                  </DropdownToggle>
                    ...
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-2">
                        ...
                        <p className="fs-12 mb-0 text-muted">
                          <i
                            className={
                              'mdi mdi-circle fs-10 align-middle me-1 text-' + item.coinNameClass
                            }
                          ></i>
                          {item.coinName}
                        </p>
              ...
              <Row className="g-3">
                <Col md={6}>
                  ...
                  <div className="d-flex">
                    <div className="flex-grow-1">
                      <p className="text-truncate text-muted fs-14 mb-0">
                        <i className="mdi mdi-circle align-middle text-danger me-2"></i>Other
                      </p>
                    </div>
                    <div className="flex-shrink-0">
