                                ...
                                <div className="avatar-group-item">
                                  <Link to="#">
                                    <div className="avatar-xxs">
                                      <span
                                        className={
                                          'avatar-title rounded-circle text-white ' + item.bgcolor
                                        }
                                      >
                                        {item.imgNumber}
                                      </span>
                    ...
                    <UncontrolledDropdown className="card-header-dropdown">
                      <DropdownToggle tag="a" className="text-reset dropdown-btn" role="button">
                        <span className="text-muted">
                          <i className="ri-settings-4-line align-middle me-1 fs-15"></i>Settings
                        </span>
                      </DropdownToggle>
                      <DropdownMenu className="dropdown-menu-end">
                        <DropdownItem>Edit</DropdownItem>
                        ...
                        <ListGroupItem className="ps-0" key={key}>
                          <div className="d-flex align-items-start">
                            ...
                            <div className="flex-grow-1">
                              <label className="form-check-label mb-0 ps-2" htmlFor={item.forId}>
                                {item.text}
                              </label>
                            </div>
                    ...
                    <div className="acitivity-timeline acitivity-main">
                      ...
                      <div className="acitivity-item py-3 d-flex">
                        ...
                        <div className="flex-grow-1 ms-3">
                          ...
                          <p className="text-muted mb-2">
                            <span className="text-danger">2 days left</span> notification to submit
                ...
                <div className="flex-grow-1 p-3">
                  ...
                  <p className="mb-0 text-muted">
                    <span className="badge bg-light text-success mb-0">
                      {' '}
                      <i className="ri-arrow-up-line align-middle"></i> {item.persantage} %{' '}
                    </span>{' '}
                    vs. previous month
                  </p>
                </div>
