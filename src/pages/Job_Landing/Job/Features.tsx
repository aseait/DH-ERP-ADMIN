                ...
                <Card className="card-bg-fill rounded shadow-lg inquiry-box d-none d-lg-block">
                  <CardBody className="d-flex align-items-center">
                    ...
                    <h5 className="fs-15 lh-base mb-0">
                      Search Over <span className="text-secondary fw-semibold">1,00,000+</span> Jobs
                    </h5>
                  </CardBody>
                </Card>
            ...
            <Col lg={6}>
              <div className="text-muted">
                <h1 className="mb-3 lh-base">
                  Find Your <span className="text-primary">Dream Job</span> in One Place
                </h1>
                <p className="ff-secondary fs-16 mb-2">
                  The first step in finding your <b>dream job </b> is deciding where to look for
                  first-hand insight. Contact professionals who are already working in industries or
                  positions that interest you.
                </p>
                <p className="ff-secondary fs-16">
                  Schedule informational interviews and phone calls or ask for the opportunity to
                ...
                <div>
                  <Link to="#!" className="btn btn-primary">
                    Find Your Jobs <i className="ri-arrow-right-line align-bottom ms-1"></i>
                  </Link>
                </div>
              </div>
            </Col>
