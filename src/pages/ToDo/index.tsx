          ...
          <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
            <div className="file-manager-sidebar">
              <div className="p-4 d-flex flex-column h-100">
                <div className="mb-3">
                  <button className="btn btn-info w-100" onClick={() => setModalProject(true)}>
                ...
                <SimpleBar className="px-4 mx-n4" style={{ height: 'calc(100vh - 468px)' }}>
                  <ul className="to-do-menu list-unstyled" id="projectlist-data">
                    {(projects || []).map((item: any, key: any) => (
                      <li key={key}>
                        <Link to="#" className="nav-link fs-14" id={'todos' + key}>
                          {item.title}
                        </Link>
                            ...
                            {(item.subItem || []).map((item: any, key: any) => (
                              <li key={key}>
                                <Link to="#">
                                  <i
                                    className={
                                      'ri-stop-mini-fill align-middle fs-15 text-' + item.iconClass
                                    }
                                  ></i>{' '}
                                  {item.version}
                                </Link>
              ...
              <Row className="mb-4">
                ...
                <div className="col-sm order-3 order-sm-2 mt-3 mt-sm-0">
                  <h5 className="fw-semibold mb-0">
                    ...
                    <span className="badge bg-primary align-bottom ms-2">v1.0.0</span>
                  </h5>
                </div>
            ...
            <div className="mb-4">
              ...
              <Flatpickr
                ...
                onChange={(dueDate: any) =>
                  validation.setFieldValue('dueDate', moment(dueDate[0]).format('DD MMMM ,YYYY'))
                }
          ...
          >
            <div className="mb-4">
              ...
              <Input
                ...
                invalid={
                  projectValidation.touched.title && projectValidation.errors.title ? true : false
                }
              />
