            ...
            <SimpleBar style={{ height: '390px' }}>
              <div className="p-3">
                ...
                <div className="d-flex align-items-center">
                  <div className="avatar-xs flex-shrink-0">
                    <span className="avatar-title bg-light rounded-circle">
                      <FeatherIcon icon="arrow-down-circle" className="icon-dual-success icon-sm" />
                    </span>
                  </div>
                  ...
                  <div className="flex-shrink-0 text-end">
                    <h6 className="mb-1 text-success">
                      +0.04025745<span className="text-uppercase ms-1">Btc</span>
                    </h6>
                ...
                <div className="d-flex align-items-center mt-3">
                  <div className="avatar-xs flex-shrink-0">
                    <span className="avatar-title bg-light rounded-circle">
                      <FeatherIcon icon="send" className="icon-dual-warning icon-sm" />
                    </span>
                  </div>
                  <div className="flex-grow-1 ms-3">
                  ...
                  <div className="flex-shrink-0 text-end">
                    <h6 className="mb-1 text-muted">
                      -0.09025182<span className="text-uppercase ms-1">Eth</span>
                    </h6>
                ...
                <div className="d-flex align-items-center">
                  <div className="avatar-xs flex-shrink-0">
                    <span className="avatar-title bg-light rounded-circle">
                      <FeatherIcon icon="arrow-up-circle" className="icon-dual-danger icon-sm" />
                    </span>
                  </div>
                  <div className="flex-grow-1 ms-3">
                  ...
                  <div className="flex-shrink-0 text-end">
                    <h6 className="mb-1 text-danger">
                      -98.6025422<span className="text-uppercase ms-1">Dash</span>
                    </h6>
                ...
                <div className="d-flex align-items-center mt-3">
                  ...
                  <div className="flex-shrink-0 text-end">
                    <h6 className="mb-1 text-danger">
                      -1058.08025142<span className="text-uppercase ms-1">Doge</span>
                    </h6>
                ...
                <div className="d-flex align-items-center mt-3">
                  <div className="avatar-xs flex-shrink-0">
                    <span className="avatar-title bg-light rounded-circle">
                      <FeatherIcon icon="arrow-up-circle" className="icon-dual-success icon-sm" />
                    </span>
                  </div>
                  <div className="flex-grow-1 ms-3">
                  ...
                  <div className="flex-shrink-0 text-end">
                    <h6 className="mb-1 text-success">
                      +0.07225912<span className="text-uppercase ms-1">Ltc</span>
                    </h6>
