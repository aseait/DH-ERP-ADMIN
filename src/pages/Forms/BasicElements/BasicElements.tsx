              ...
              <Card>
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Use <code>form-control-lg</code> class to set large size input and Use{' '}
                    <code>form-control-sm</code> class to set small size input. No class is needed
                    ...
                    <Row className="align-items-center g-3">
                      <Col lg={4}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>input</code> attribute with <code>type="file"</code> tag for
                            default file input.
                          </p>
                      ...
                      <Col lg={4}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>multiple</code> attribute within the input attribute to select
                            multiple files.
                          </p>
                          <Input
                            className="form-control"
                      ...
                      <Col lg={4}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>disabled</code> attribute within the input attribute to
                    ...
                    <Row className="mt-4 align-items-center g-3">
                      ...
                      <Col lg={4}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>form-control-sm</code> class within the form-control class to
                            set a small size file input.
                          </p>
                          <Input
                            className="form-control form-control-sm"
                            id="formSizeSmall"
                      ...
                      <Col lg={4}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>form-control </code>class and <code>type="file"</code>{' '}
                      ...
                      <Col lg={4}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>form-control-lg</code> class within the form-control class to
                            set a large size file input.
                          </p>
                ...
                <CardBody>
                  <div className="live-preview">
                    <div>
                      ...
                      <p className="text-muted">
                        Use <code>input-group</code> class to div element which contains input
                        attribute to wrap a default input in the group.
                      </p>
                      <Row className="g-3">
                        <Col lg={6}>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Use <code>input-group-sm</code> class to set a small size input group and{' '}
                    <code>input-group-lg</code> class to input-group class to set a large size input
                    group respectively. no such class is required for a default size input group.
                  </p>
                  <div className="live-preview">
                    <Row className="align-items-center g-3">
                      <Col lg={4}>
          ...
          <Row>
            <Col lg={12}>
              <div className="card">
                ...
                <div className="card-body">
                  <p className="text-muted">
                    While multiple <code>&lt;input&gt;</code>s are supported visually, validation
                  ...
                  <div className="live-preview">
                    <div>
                      <p className="text-muted">
                        ...
                        <code>form-check-input</code> when there’s no visible text next to the
                        input.
                      </p>
                      <Row className="g-3">
                        <Col lg={6}>
