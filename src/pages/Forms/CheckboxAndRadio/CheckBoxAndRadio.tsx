                    ...
                    <Row>
                      <Col lg={4} md={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>type="checkbox"</code> attribute to set a checkbox and add{' '}
                            <code>defaultChecked</code> attribute to set a checkbox checked by
                            default.
                          </p>
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <p className="text-muted">
                            Use <code>form-check-right</code> class to form-check class to set a
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col md={6}>
                        <div>
                          <p className="text-muted">
                            Use <code>form-check-</code> class with below-mentioned color variation
                            to set a color checkbox.
                          </p>
                          <div>
                      ...
                      <Col md={6}>
                        <div className="mt-4 mt-md-0">
                          <p className="text-muted">
                            Use <code>form-check-outline</code> class and <code>form-check-</code>{' '}
                            class with below-mentioned color variation to set a color checkbox with
                            outline.
                          </p>
                    ...
                    <Row>
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <p className="text-muted">
                            Use <code>disabled</code> attribute to set a radio button disabled and
                            add <code>defaultChecked</code> attribute to set a radio checked by
                            default.
                          </p>
                          <div className="form-check mb-2">
                            <Input
                    ...
                    <Row>
                      ...
                      <Col md={6}>
                        <div className="mt-4 mt-md-0">
                          <p className="text-muted">
                            Use <code>form-check-outline</code> class and <code>form-check-</code>{' '}
                            class with below-mentioned color variation to set a color radio with
                            outline.
                          </p>
                    ...
                    <Row>
                      <Col lg={4} md={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>form-switch</code> class to form-check class to set a switch
                            and add <code>defaultChecked</code> attribute to set a switch checked by
                            default.
                          </p>
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <p className="text-muted">
                            Use <code>disabled</code> attribute to set a radio button disabled and
                            add <code>defaultChecked</code> attribute to set a switch checked by
                            default.
                          </p>
                          <div className="form-check form-switch mb-2">
                            <Input
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-3">
                          ...
                          <p className="text-muted">
                            Use <code>form-switch-md</code> class to set a medium size switch button
                            and
                            <code>form-switch-lg</code> class to form-check class to set a large
                            size switch button respectively. No such class is required for small
                            size switch button.
                          </p>
            ...
            <div className="col-12">
              <Card>
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Use <code>form-check-</code> class with below-mentioned color variation to set a
                    color switch.
                  </p>
                  <div className="live-preview">
                    <Row>
          ...
          <Row>
            <div className="col-12">
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>form-switch-custom</code> class &amp; <code>form-switch-</code> class
                    with below-mentioned color variation to set a color radius.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col md={6}>
          ...
          <Row>
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>form-check-inline</code> class to form-check class to set horizontally
          ...
          <Row>
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Omit the wrapping, <code>form-check</code> class for checkboxes, radios, or
                    switches that have no label text. Remember to still provide some form of
                    accessible name for assistive technologies (for instance, using aria-label).
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col lg={4}>
          ...
          <Row>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    rather than form-check-label class on the &lt;label&gt; elements. These toggle
            ...
            <Col lg={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Different variants of <code>btn</code> attribute, such as the various outlined
