                    ...
                    <div>
                      <div>
                        ...
                        <p className="text-muted">
                          Use <code>form-range</code> class to create a default range.
                        </p>
                      ...
                      <div className="mt-4">
                        ...
                        <p className="text-muted">
                          Use <code>disabled</code> attribute on an input to give it a grayed out
                      ...
                      <div className="mt-4">
                        ...
                        <p className="text-muted">
                          Use <code>min</code> and <code>max</code> attribute with specified range
                          input respectively.
                        </p>
                      ...
                      <div className="mt-4">
                        ...
                        <p className="text-muted">
                          ...
                          by using <code>step="0.5"</code> attribute.
                        </p>
                  ...
                  <Row>
                    <Col xl={4} lg={6}>
                      <div>
                        ...
                        <p className="text-muted mb-4">
                          Use <code>data-rangeslider data-slider-color=&quot;primary&quot;</code>{' '}
                          attribute to set primary color scheme.
                        </p>
                        <div data-rangeslider data-slider-color="primary">
                          <Nouislider range={{ min: 0, max: 100 }} start={[10, 50]} connect />
                        </div>
                      </div>
                    </Col>
                    ...
                    <Col xl={4} lg={6}>
                      <div className="mt-4 mt-lg-0">
                        ...
                        <p className="text-muted mb-4">
                          Use <code>data-rangeslider data-slider-color=&quot;secondary&quot;</code>{' '}
                    ...
                    <Col xl={4} lg={6}>
                      <div className="mt-4 mt-xl-0">
                        ...
                        <p className="text-muted mb-4">
                          Use <code>data-rangeslider data-slider-color=&quot;success&quot;</code>{' '}
                  ...
                  <Row className="mt-4">
                    <Col xl={4} lg={6}>
                      <div className="mt-4">
                        ...
                        <p className="text-muted mb-4">
                          Use <code>data-rangeslider data-slider-color=&quot;info&quot;</code>{' '}
                    ...
                    <Col xl={4} lg={6}>
                      <div className="mt-4">
                        ...
                        <p className="text-muted mb-4">
                          Use <code>data-slider-color=&quot;warning&quot;</code> attribute to set
                    ...
                    <Col xl={4} lg={6}>
                      <div className="mt-4">
                        ...
                        <p className="text-muted mb-4">
                          Use <code>data-rangeslider data-slider-color=&quot;danger&quot;</code>{' '}
                  ...
                  <Row className="mt-4">
                    <Col xl={4} lg={6}>
                      <div className="mt-4">
                        ...
                        <p className="text-muted mb-4">
                          Use <code>data-rangeslider data-slider-color=&quot;dark&quot;</code>{' '}
