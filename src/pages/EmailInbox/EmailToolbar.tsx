...
const EmailToolbar = () => {
  ...
  const readAll = (ele: any) => {
    if (ele === 'unread') {
      document.querySelectorAll('.message-list li.active:not(.unread)').forEach(function (
        element: any
      ) {
                  ...
                  filteredMails.map((item: any, key: any) => (
                    <li className={classnames({ unread: item.unread })} key={key} id={item.forId}>
                      <div className="col-mail col-mail-1">
                        ...
                        <Link to="#" className="title" onClick={() => sidebarToggle(item)}>
                      ...
                      <div className="col-mail col-mail-2" onClick={() => sidebarToggle(item)}>
                        <Link to="#" className="subject">
                          {' '}
                          {item.badge ? <span className="me-2 ">{item.badge}</span> : null}{' '}
          ...
          <CardBody className="p-0">
              ...
              >
                ...
                >
                  {(messages || []).map((item: any, key: number) => (
                    <li className={item.isSender ? 'chat-list left' : 'chat-list right'} key={key}>
                          ...
                          <div className="ctext-wrap">
                            ...
                            <UncontrolledDropdown className="align-self-start message-box-drop">
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownItem onClick={(e: any) => copyMessage(e.target)}>
            ...
            <div className="border-top border-top-dashed">
              <Row className="g-2 mx-3 mt-2 mb-3">
                ...
                <Col className="col-auto">
                  <button type="submit" className="btn btn-info" onClick={() => onSendMessage()}>
