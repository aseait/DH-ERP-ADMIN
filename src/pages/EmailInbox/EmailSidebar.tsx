          ...
          <SimpleBar className="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
            <div className="mail-list mt-3">
              <Link to="#" className="active">
                <i className="ri-inbox-archive-fill me-3 align-middle fw-medium"></i> Inbox{' '}
                <span className="badge bg-success-subtle text-success ms-auto  ">5</span>
              </Link>
              <Link to="#">
                <i className="ri-send-plane-2-fill me-3 align-middle fw-medium"></i> Sent
              </Link>
              <Link to="#">
            ...
            <div>
              ...
              <div className="mail-list mt-1">
                <Link to="#">
                  <span className="ri-checkbox-blank-circle-line me-2 text-info"></span> Theme
                  Support <span className="badge bg-success-subtle text-success ms-auto">3</span>
                </Link>
                <Link to="#">
                ...
                <Link to="#">
                  <span className="ri-checkbox-blank-circle-line me-2 text-primary"></span> Social
                </Link>
                <Link to="#">
                  <span className="ri-checkbox-blank-circle-line me-2 text-danger"></span> Friends
                  <span className="badge bg-success-subtle text-success ms-auto">2</span>
                </Link>
                <Link to="#">
                  <span className="ri-checkbox-blank-circle-line me-2 text-success"></span> Family
                </Link>
              </div>
            </div>
            ...
            <div className="border-top border-top-dashed pt-3 mt-3">
              ...
              <div className="mt-2 vstack gap-3 email-chat-list mx-n4">
                ...
                <Link to="#" className="d-flex align-items-center">
                  <div className="flex-shrink-0 me-2 avatar-xs">
                    <img className="img-fluid rounded-circle" src={image4} alt="" />
                  </div>
                ...
                <Link to="#" className="d-flex align-items-center">
                  <div className="flex-shrink-0 me-2 avatar-xs">
                    <img className="img-fluid rounded-circle" src={image5} alt="" />
                  </div>
