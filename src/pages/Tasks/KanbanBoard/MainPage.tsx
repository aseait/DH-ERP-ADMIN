...
const TasksKanban = () => {
  ...
  const TasksKanbanProperties = createSelector(selectLayoutState, (state: any) => ({
    tasks: state.tasks,
  ...
  const handleDragEnd = (result: any) => {
    ...
    if (source.droppableId === destination.droppableId) {
      ...
      const destinationLine = cards.find((line: any) => line.id === destination.droppableId);
  ...
  return (
    <React.Fragment>
              ...
              return (
                ...
                <div className="tasks-list" key={line.id}>
                  <div className="d-flex mb-3">
                    ...
                    <div className="flex-shrink-0">
                      <UncontrolledDropdown className="card-header-dropdown float-end">
                        <DropdownToggle className="text-reset dropdown-btn" tag="a" color="white">
                  ...
                  <SimpleBar className="tasks-wrapper px-3 mx-n3">
                    <div
                      id="unassigned-task"
                      className={line.cards === 'object' ? 'tasks' : 'tasks noTask'}
                    >
                                          ...
                                          <UncontrolledDropdown className="float-end">
                                            ...
                                            <DropdownMenu className="dropdown-menu-end">
                                              ...
                                              <DropdownItem
                                                ...
                                                onClick={() => handleCardEdit(card, line)}
                                              >
                                                Edit
                                              </DropdownItem>
                                              <DropdownItem
              ...
              <Row>
                ...
                <div className="mt-4">
                  <div className="hstack gap-2 justify-content-end">
                    ...
                    <button type="submit" className="btn btn-success" id="addNewBoard">
                      Add Board
                    </button>
                  </div>
                </div>
      ...
      <Modal id="modalForm" isOpen={modal} toggle={toggle} centered={true} size="lg">
        <ModalHeader toggle={toggle}>{!!isEdit ? 'Update Task' : 'Add New Task'}</ModalHeader>
        <ModalBody>
          <Form
            onSubmit={(e) => {
              e.preventDefault();
          ...
          >
            ...
            <div className="form-group mb-3">
              ...
              <SimpleBar style={{ height: '200px' }}>
                <ul className="list-unstyled user-list validate" id="taskassignee">
                    ...
                    return (
                      <li key={index}>
                        <div className="form-check form-check-primary mb-2 d-flex align-items-center">
                          ...
                          <img src={image.img} className="rounded-circle avatar-xs m-1" alt="" />
                        </div>
                      </li>
                    );
                  })}
            ...
            <div className="form-group mb-4">
              ...
              <Flatpickr
                ...
                onChange={(botId: any) =>
                  validation.setFieldValue('botId', moment(botId[0]).format('DD MMMM ,YYYY'))
                }
              ...
              <div>
                ...
                <Col lg={4}>
                  <Input
                    ...
                    invalid={validation.touched.eye && validation.errors.eye ? true : false}
                  />
                  {validation.touched.eye && validation.errors.eye ? (
                    <FormFeedback type="invalid">{validation.errors.eye}</FormFeedback>
                  ) : null}
                </Col>
              </div>
              <div>
                ...
                <Col lg={4}>
                  <Input
                    ...
                    invalid={validation.touched.que && validation.errors.que ? true : false}
                  />
                  {validation.touched.que && validation.errors.que ? (
                    <FormFeedback type="invalid">{validation.errors.que}</FormFeedback>
                  ) : null}
                </Col>
              </div>
              <div>
                ...
                <Col lg={4}>
                  <Input
                    ...
                    invalid={!!(validation.touched.clip && validation.errors.clip)}
                  />
                  {validation.touched.clip && validation.errors.clip ? (
                    <FormFeedback type="invalid">{validation.errors.clip}</FormFeedback>
                  ) : null}
                </Col>
              </div>
            </div>
            ...
            <Row>
              <Col lg={10}>
                <button type="submit" className="btn btn-primary" id="updatetaskdetail">
