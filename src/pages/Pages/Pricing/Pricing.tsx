                      ...
                      <CardBody className="h-100">
                        ...
                        <div className="py-4">
                          <h2>
                            ...
                            {price3.rate} <span className="fs-13 text-muted">/Per month</span>
                          </h2>
                        </div>

                        <div className="text-center plan-btn mt-2">
                          <Link to="#" className="btn btn-success w-sm waves-effect waves-light">
                            Sign up
                          </Link>
                        </div>
                      </CardBody>
                      ...
                      <CardBody className="border-start mt-4 mt-lg-0">
                        ...
                        <CardBody className="pb-0">
                          <ul className="list-unstyled vstack gap-3 mb-0">
                            <li>
                              Users:{' '}
                              <span className="text-success fw-semibold">{price3.users}</span>
                            </li>
                            <li>
                              Storage:{' '}
                              <span className="text-success fw-semibold">{price3.storage} GB</span>
                            </li>
                            <li>
                              Domain:{' '}
                              <span className="text-success fw-semibold">{price3.domain}</span>
                            </li>
                            <li>
                              Support:{' '}
                              <span className="text-success fw-semibold">{price3.support}</span>
                            </li>
                          </ul>
                        </CardBody>
                      </CardBody>
