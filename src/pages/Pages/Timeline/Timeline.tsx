                ...
                <div className="timeline">
                    ...
                    <div className="content">
                      <div className="d-flex">
                        ...
                        <div className="flex-grow-1 ms-3">
                          <h5 className="fs-14">
                            @Erica245{' '}
                            <small className="text-muted fs-13 fw-normal">- 10 min Ago</small>
                          </h5>
                          <p className="text-muted mb-2">
                            Wish someone a sincere ‘good luck in your new job’ with these sweet
                            messages. Make sure you pick out a good luck new job card to go with the
                            words, and pop a beautiful bunch of flowers from our gift range in your
                  ...
                  <div className="timeline-item right">
                    ...
                    <div className="content">
                      ...
                      <p className="text-muted fst-italic mb-2">
                        " This is an awesome admin dashboard template. It is extremely well
                        structured and uses state of the art components (e.g. one of the only
                        templates using boostrap 5.1.3 so far). I integrated it into a Rails 6
                        project. Needs manual integration work of course but the template structure
                        made it easy. "
                      </p>
                      <div className="hstack gap-2">
                  ...
                  <div className="timeline-item left">
                    ...
                    <div className="content">
                      ...
                      <p className="text-muted">
                        Powerful, clean & modern responsive bootstrap 5 admin template. The maximum
                      ...
                      <Col xs={12}>
                        <div className="timeline-box">
                          <div className="timeline-text">
                            ...
                            <p className="text-muted">
                              In the trip planner, keep only one or two activities in a day if the
                              purpose of the trip is to relax and take it easy during the vacation :
                            </p>
                            <Row className="border border-dashed rounded gx-2 p-2">
                              <Col xs={3}>
                                <Link to="#">
                        ...
                        <div className="timeline-box">
                          <div className="timeline-text">
                            ...
                            <p className="text-muted mb-0">
                              ...
                              understanding or fresh insights about the problem after you've taken
                      ...
                      <Col xs={12}>
                        <div className="timeline-box">
                          <div className="timeline-text">
                            ...
                            <p className="text-muted mb-0">
                              A client meeting, meaning, direct collaboration and communication with
                              a customer, is the best way to understand their needs and how you can
                              help support them.
                            </p>
                          </div>
                        </div>
