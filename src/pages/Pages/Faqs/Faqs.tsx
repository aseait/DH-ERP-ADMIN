                    ...
                    <Col xxl={5} className="align-self-center">
                      <div className="py-4">
                        ...
                        <p className="text-success fs-15 mt-3">
                          If you can not find answer to your question in our FAQ, you can always
                          contact us or email us. We will answer you shortly!
                        </p>
                      ...
                      <div className="accordion-item">
                        ...
                        <Collapse isOpen={col1} className="accordion-collapse">
                          <div className="accordion-body">
                            ...
                            European languages. It will be as simple their most common words.
                          </div>
                        </Collapse>
                      </div>
                      <div className="accordion-item">
                      ...
                      <div className="accordion-item">
                        ...
                        <Collapse isOpen={col3} className="accordion-collapse">
                          <div className="accordion-body">
                            ...
                            else he endures pains to avoid worse pains.But I must explain to you how
