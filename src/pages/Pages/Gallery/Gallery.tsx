                    ...
                    <Col lg={12}>
                        ...
                        <ul className="list-inline categories-filter animation-nav" id="filter">
                          <li className="list-inline-item">
                            <Link
                              ...
                              className={
                                displayCategory === 'All' ? 'categories active' : 'categories'
                              }
                              data-filter="*"
                            >
                              All
                          ...
                          <li className="list-inline-item">
                            <Link
                              ...
                              className={
                                displayCategory === 'Project' ? 'categories active' : 'categories'
                              }
                              data-filter=".project"
                            >
                              Project
                          ...
                          <li className="list-inline-item">
                            <Link
                              ...
                              className={
                                displayCategory === 'Designing' ? 'categories active' : 'categories'
                              }
                      ...
                      <div className="text-center my-2">
                        <Link to="#" className="text-success">
                          <i className="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load
                          More{' '}
                        </Link>
                      </div>
                    </Col>
