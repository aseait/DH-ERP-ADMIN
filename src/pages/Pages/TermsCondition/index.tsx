                ...
                <CardBody className="p-4">
                  <div>
                    ...
                    <p className="text-muted">
                      ...
                      Company Name's Website, located at Website.com.
                    </p>
                    <p className="text-muted">
                      By accessing this website we assume you accept these terms and conditions. Do
                      not continue to use Website Name if you do not agree to take all of the terms
                  ...
                  <div>
                    ...
                    <p className="text-muted">
                      ...
                      intellectual property rights are reserved. You may access this from Website
                      Name for your own personal use subjected to restrictions set in these terms
                      and conditions.
                    </p>
                    ...
                    <p className="text-muted">
                      ...
                      opinions and information in certain areas of the website. Company Name does
                      not filter, edit, publish or review Comments prior to their presence on the
                      website. Comments do not reflect the views and opinions of Company Name,its
                  ...
                  <div>
                    ...
                    <p className="text-muted">
                      You hereby grant Company Name a non-exclusive license to use, reproduce, edit
