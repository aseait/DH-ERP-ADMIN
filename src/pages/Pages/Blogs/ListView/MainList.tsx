                    ...
                    <div className="col-xxl-9 col-lg-7">
                      ...
                      <div className="d-flex align-items-center gap-2 mb-3 flex-wrap">
                        <span className="text-muted">
                          <i className="ri-calendar-event-line me-1"></i> {item.date}
                        </span>{' '}
                        |{' '}
                        <span className="text-muted">
                      ...
                      <Link to="/pages-blog-overview" className="text-decoration-underline">
                        Read more <i className="ri-arrow-right-line"></i>
                      </Link>
                      <div className="d-flex align-items-center gap-2 mt-3 flex-wrap">
                        {item.tags.map((item, idx) => (
                          <Link to="#!" key={idx} className="badge text-success bg-success-subtle">
                            {item}
                          </Link>
                        ))}
                      </div>
          ...
          <div className="col-sm-6">
            <div>
              <p className="mb-sm-0 text-muted">
                ...
                <span className="fw-semibold text-decoration-underline">21</span> entries
              </p>
            </div>
          </div>
          <div className="col-sm-6">
