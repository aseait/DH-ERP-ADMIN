  ...
  function countUP(id: any, prev_data_attr: any, itemPrice: any) {
    setproductList(
      productList.map((p: any) =>
        p.id === id
          ? { ...p, data_attr: prev_data_attr + 1, total: (prev_data_attr + 1) * itemPrice }
          : p
      )
    );
  }
                      ...
                      <Row className="gy-3">
                        ...
                        <div className="col-sm">
                          <h5 className="fs-14 text-truncate">
                            <Link to="/ecommerce-product-detail" className="text-body">
                              {cartItem.name}
                            </Link>
                          </h5>
                          ...
                          <div className="d-flex flex-wrap my-n1">
                            ...
                            <div>
                              <Link to="#" className="d-block text-body p-1 px-2">
                                <i className="ri-star-fill text-muted align-bottom me-1"></i> Add
                                Wishlist
                              </Link>
                            </div>
                          </div>
