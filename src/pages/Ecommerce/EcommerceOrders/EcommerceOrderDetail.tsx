        ...
        <Row>
              ...
              <CardHeader>
                <div className="d-sm-flex align-items-center">
                  ...
                  <div className="flex-shrink-0 mt-2 mt-sm-0">
                    <Link to="#" className="btn btn-soft-info btn-sm mt-2 mt-sm-0">
                      <i className="ri-map-pin-line align-middle me-1"></i> Change Address
                    </Link>{' '}
                    <Link to="#" className="btn btn-soft-danger btn-sm mt-2 mt-sm-0">
                      <i className="mdi mdi-archive-remove-outline align-middle me-1"></i> Cancel
                      Order
                    </Link>
                  </div>
                </div>
          ...
          <Col xl={3}>
            ...
            <Card>
              <CardHeader>
                <h5 className="card-title mb-0">
                  <i className="ri-secure-payment-line align-bottom me-1 text-muted"></i> Payment
                  Details
                </h5>
              </CardHeader>
              <CardBody>
