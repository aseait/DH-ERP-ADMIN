                            ...
                            <td>
                              ...
                              <div className="d-flex align-items-center">
                                <div className="flex-shrink-0 fs-17 me-2 filelist-icon">
                                  <i
                                    className={
                                      item.icon + ' text-' + item.iconClass + ' align-bottom'
                                    }
                                  />
                                </div>
                ...
                <Row>
                  ...
                  <Col>
                    ...
                    <Input
                      ...
                      invalid={
                        folderValidation.touched.size && folderValidation.errors.size ? true : false
                      }
                    />
          ...
          >
            <div className="mb-4">
              ...
              <Input
                ...
                invalid={
                  fileValidation.touched.fileName && fileValidation.errors.fileName ? true : false
                }
              />
