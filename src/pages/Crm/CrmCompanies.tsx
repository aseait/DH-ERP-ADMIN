                    ...
                    >
                      <ModalBody>
                        ...
                        <Row className="g-3">
                              ...
                              <div className="position-relative d-inline-block">
                                ...
                                >
                                  <div className="avatar-title bg-light rounded-circle">
                                    <img
                                      src={selectedImage || validation.values.picture || multiUser}
                                      alt="multiUser"
                                      id="companylogo-img"
                          ...
                          <Col lg={6}>
                            <div>
                              <Label htmlFor="industryType-field" className="form-label">
                                Industry Type
                              </Label>
                              ...
                              <Input
                                ...
                                invalid={
                                  validation.touched.industryType && validation.errors.industryType
                                    ? true
                                    : false
                                }
                              >
              ...
              <Card id="company-view-detail">
                ...
                <div className="card-body">
                  ...
                  <p className="text-muted mb-4">
                    ...
                    salaries and overhead, as explained by AccountingTools, Inc. Business owners
                    have the discretion to determine the actions.
                  </p>
