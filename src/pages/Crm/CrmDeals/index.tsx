          ...
          <ModalBody>
            <div className="mb-3">
              ...
              <Input
                ...
                invalid={validation.touched.dealType && validation.errors.dealType ? true : false}
              >
            ...
            <div className="mb-3">
              ...
              <Input
                ...
                onChange={validation.handleChange}
                onBlur={validation.handleBlur}
                invalid={validation.touched.subTitle && validation.errors.subTitle ? true : false}
              />
            ...
            <div className="mb-3">
              ...
              <Flatpickr
                ...
                onChange={(date: any) =>
                  validation.setFieldValue('date', moment(date[0]).format('DD MMMM ,YYYY'))
                }
            ...
            <div className="mb-3">
              ...
              <Input
                ...
                onChange={validation.handleChange}
                onBlur={validation.handleBlur}
                invalid={validation.touched.contact && validation.errors.contact ? true : false}
              />
