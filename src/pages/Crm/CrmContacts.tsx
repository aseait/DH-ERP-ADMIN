          ...
          <>
            <div className="d-flex align-items-center">
              <div className="flex-shrink-0">
                <img src={cell.row.original.img} alt="" className="avatar-xs rounded-circle" />
              </div>
        ...
        cell: (cell: any) => (
          <>
            {cell.getValue().map((item: any, key: any) => (
              <span className="badge bg-primary-subtle text-primary me-1" key={key}>
                {item}
              </span>
            ))}
          </>
                    ...
                    >
                      <ModalBody>
                        ...
                        <Row className="g-3">
                          ...
                          <Col lg={12}>
                            <div>
                              <Label htmlFor="emailid-field" className="form-label">
                                Email ID
                              </Label>
              ...
              <Card id="contact-view-detail">
                ...
                <CardBody>
                  ...
                  <p className="text-muted mb-4">
                    ...
                    that is tailored to the job you are applying for. It states what kind of career
                    ...
                    <Table className="table table-borderless mb-0">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {(info.tags || ['Lead', 'Partner']).map((item: any, key: any) => (
                              <span className="badge bg-primary-subtle text-primary me-1" key={key}>
                                {item}
                              </span>
                            ))}
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <small className="text-muted">
                              {handleValidTime(info.date || '2021-04-13T18:30:00.000Z')}
                            </small>
                          </td>
                        </tr>
                      </tbody>
