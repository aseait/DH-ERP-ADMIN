      ...
      <Card>
        <CardBody>
          ...
          <p className="text-muted mb-2">
            A Product Designer of a company is responsible for the user experience of a product,
            which usually includes taking direction on the business goals and objectives from
            product management. Product Designers are typically associated with the vis ual or
            tactile aspects of a product but sometimes they can also play a role in the information
            architecture and system design of a product.
          </p>
          <p className="text-muted mb-4">
            Product designer is an exceptional career choice. The demand for product designers is
            increasing with each passing day but there is a huge shortage for a skilful product
            designer in the market. With hard work and an apt skill set, a product designer can make
          ...
          <div>
            ...
            <ul className="text-muted vstack gap-2">
              ...
              <li>To present ideas and concepts to relevant team members for brainstorming.</li>
          ...
          <div>
            ...
            <ul className="text-muted vstack gap-2">
              ...
              <li>Eye for aesthetic design and understanding of customer appeal</li>
