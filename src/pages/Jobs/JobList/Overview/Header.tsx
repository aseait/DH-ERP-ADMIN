                    ...
                    <div className="col-md">
                      <div>
                        ...
                        <div className="hstack gap-3 flex-wrap">
                          ...
                          <div>
                            <i className="ri-map-pin-2-line align-bottom me-1"></i> Zuweihir, UAE
                          </div>
                          <div className="vr"></div>
                          <div>
                            Post Date : <span className="fw-semibold">15 Sep, 2021</span>
                          </div>
                          <div className="vr"></div>
                          <div className="badge rounded-pill bg-success fs-12">Full Time</div>
                        </div>
                      </div>
                    </div>
                  </Row>
