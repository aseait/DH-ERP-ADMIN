...
const RaterWithStepExample = () => (
  <PrismCode code={raterWithStepCode} language={'js'} plugins={['line-numbers']} />
);
...
const ReadOnlyRaterExample = () => (
  <PrismCode code={readOnlyRaterCode} language={'js'} plugins={['line-numbers']} />
);
...
const ReasetRaterExample = () => (
  <PrismCode code={reasetRaterCode} language={'js'} plugins={['line-numbers']} />
);
