              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>SimpleBar</code> attribute and add <code>max-height: **px</code> to
              ...
              <Row>
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="primary"</code> attribute to set primary
                        color simplebar track.
                      </p>
                          ...
                          >
                            <div className="d-flex">
                              ...
                              <div className="flex-grow-1 text-muted">
                                <p className="m-0">
                                  Your <span className="fw-semibold text-body">Elite</span> author
                          ...
                          >
                            <div className="d-flex">
                              ...
                              <div className="flex-grow-1 text-muted">
                                <p className="m-0">
                                  You have received{' '}
                                  <span className="fw-semibold text-success">20</span> new messages
                                  in the conversation
                                </p>
                              </div>
                              <div className="flex-shrink-0 ms-2">
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="secondary"</code> attribute to set secondary
                        color simplebar track.
                      </p>
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="success"</code> attribute to set success
                        color simplebar track.
                      </p>
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="info"</code> attribute to set info color
                        simplebar track.
                      </p>
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="warning"</code> attribute to set warning
                        color simplebar track.
                      </p>
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="danger"</code> attribute to set danger color
                        simplebar track.
                      </p>
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="dark"</code> attribute to set dark color
                        simplebar track.
                      </p>
