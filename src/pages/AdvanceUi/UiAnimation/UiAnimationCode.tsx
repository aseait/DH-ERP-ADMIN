...
const FadeUpRightExample = () => (
  <PrismCode code={fadeUpRightCode} language={'js'} plugins={['line-numbers']} />
);
...
const FadeDownRightExample = () => (
  <PrismCode code={fadeDownRightCode} language={'js'} plugins={['line-numbers']} />
);
...
const FadeDownLeftExample = () => (
  <PrismCode code={fadeDownLeftCode} language={'js'} plugins={['line-numbers']} />
);
...
const ZoomOutDownExample = () => (
  <PrismCode code={zoomOutDownCode} language={'js'} plugins={['line-numbers']} />
);
...
const ZoomInRightExample = () => (
  <PrismCode code={zoomInRightCode} language={'js'} plugins={['line-numbers']} />
);
...
const ZoomOutRightExample = () => (
  <PrismCode code={zoomOutRightCode} language={'js'} plugins={['line-numbers']} />
);
...
const ZoomOutLeftExample = () => (
  <PrismCode code={zoomOutLeftCode} language={'js'} plugins={['line-numbers']} />
);
...
const EasingLinearExample = () => (
  <PrismCode code={easingLinearCode} language={'js'} plugins={['line-numbers']} />
);
...
const EaseOutCubicExample = () => (
  <PrismCode code={easeOutCubicCode} language={'js'} plugins={['line-numbers']} />
);
