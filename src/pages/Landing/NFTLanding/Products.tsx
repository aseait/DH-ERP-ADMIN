            ...
            <Col lg={8}>
              <div className="text-center mb-5">
                ...
                <p className="text-muted mb-4">
                  ...
                  as a collection of pictures from a collection of articles.
                </p>
                <Nav pills className="nav-pills filter-btns justify-content-center" role="tablist">
                  <NavItem role="presentation">
                    <NavLink
                      type="button"
                      onClick={() => setNav('All')}
                      className={nav === 'All' ? ' fw-medium active' : 'fw-medium text-primary'}
                    >
                      All Items
                    </NavLink>
                  </NavItem>
                  <NavItem role="presentation">
                    <NavLink
                      ...
                      className={nav === 'artwork' ? ' fw-medium active' : 'fw-medium text-primary'}
                    >
                      Artwork
                    </NavLink>
                  </NavItem>
                  <NavItem role="presentation">
                    <NavLink
                      ...
                      className={nav === 'music' ? ' fw-medium active' : 'fw-medium text-primary'}
                    >
                      Music
                    </NavLink>
                  </NavItem>
                  <NavItem role="presentation">
                    <NavLink
                      ...
                      className={nav === 'games' ? ' fw-medium active' : 'fw-medium text-primary'}
                    >
                      Games
                    </NavLink>
                  </NavItem>
                  <NavItem role="presentation">
                    <NavLink
                      ...
                      className={
                        nav === 'crypto-card' ? ' fw-medium active' : 'fw-medium text-primary'
                      }
                    >
                      Crypto Card
                    </NavLink>
                  ...
                  <NavItem role="presentation">
                    <NavLink
                      ...
                      className={
                        nav === '3d-style' ? ' fw-medium active' : 'fw-medium text-primary'
                      }
                    >
                      3d Style
                    </NavLink>
