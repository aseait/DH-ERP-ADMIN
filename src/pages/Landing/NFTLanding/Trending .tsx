            ...
            <Col lg={5}>
              <div className="text-center mb-5">
                ...
                <p className="text-muted">
                  The process of creating an NFT may cost less than a dollar, but the process of
                  selling it can cost up to a thousand dollars. For example, Allen Gannett, a
                  software developer.
                </p>
              </div>
            </Col>
                      ...
                      <CardBody>
                        ...
                        <h5 className="mb-0 fs-16">
                          <Link to="#" className="text-body">
                            Artwork{' '}
                            <span className="badge bg-success-subtle text-success">206</span>
                          </Link>
                        </h5>
                      </CardBody>
                    </Card>
                    ...
                    <Card>
                      <CardBody>
                        ...
                        <h5 className="mb-0 fs-16">
                          <Link to="#" className="text-body">
                            Crypto Card{' '}
                            <span className="badge bg-success-subtle text-success">743</span>
                          </Link>
                        </h5>
                      </CardBody>
                    </Card>
                  ...
                  <SwiperSlide>
                    <Card>
                      <CardBody>
                        ...
                        <h5 className="mb-0 fs-16">
                          <Link to="#" className="text-body">
                            Music <span className="badge bg-success-subtle text-success">679</span>
                          </Link>
                        </h5>
                      </CardBody>
                    </Card>
                  ...
                  <SwiperSlide>
                    <Card>
                      <CardBody>
                        ...
                        <h5 className="mb-0 fs-16">
                          <Link to="#" className="text-body">
                            Games <span className="badge bg-success-subtle text-success">341</span>
                          </Link>
                        </h5>
                      </CardBody>
                    </Card>
                    ...
                    <Card>
                      <CardBody>
                        ...
                        <h5 className="mb-0 fs-16">
                          <Link to="#" className="text-body">
                            Photography{' '}
                            <span className="badge bg-success-subtle text-success">1452</span>
                          </Link>
                        </h5>
                      </CardBody>
                    </Card>
