          ...
          <CardBody>
            <div className="d-flex mb-3">
              ...
              <div className="flex-shrink-0">
                <Link to="#" className="badge bg-warning-subtle text-warning badge-border">
                  BTC{' '}
                </Link>
                &nbsp;
                <Link to="#" className="badge bg-info-subtle text-info badge-border">
                  ETH
                </Link>
                &nbsp;
                <Link to="#" className="badge bg-primary-subtle text-primary badge-border">
                  USD
                </Link>
                &nbsp;
                <Link to="#" className="badge bg-danger-subtle text-danger badge-border">
                  EUR
                </Link>
              </div>
            </div>
