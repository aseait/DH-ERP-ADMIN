              ...
              <Card className="bg-primary" style={{ backgroundImage: `url(${BgPattern})` }}>
                <CardBody className="p-4">
                  ...
                  <p className="text-white text-opacity-75 mb-3">
                    Take advantage of the first text-based NFT. Select a text or write your own and
                    let it live forever on the Ethereum blockchain you or future owners can add text
                    to an existing ChainText token..
                  </p>
                ...
                <Card>
                  ...
                  <CardBody className="text-center">
                    ...
                    <div>
                      <button
                        className={
                          item.isFollow ? 'btn btn-primary btn-sm' : 'btn btn-soft-primary btn-sm'
                        }
                      >
