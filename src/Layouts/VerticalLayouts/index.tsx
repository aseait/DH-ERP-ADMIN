 ...
 */
  ...
  // NOTE: this only marks which link is the "active" one (for highlighting);
  // it must NOT touch the collapse 'show' class — that's owned entirely by
  // React's <Collapse isOpen={...}> driven by LayoutMenuData's openMenus
  // state. Manually adding/removing 'show' here fights that state and was
  // the cause of dropdowns visually collapsing on routes (like the detail
  // pages) that have no matching sidebar link.
